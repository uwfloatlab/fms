...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: fmsRossSeaIce.cpp,v 1.8 2006/11/04 16:42:47 swift Exp swift $
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 *
 * \begin{verbatim}
 * $Log: fmsRossSeaIce.cpp,v $
 * Revision 1.8  2006/11/04 16:42:47  swift
 * Changed to RossSeaIce hydrography.
 *
 * Revision 1.7  2005/06/01 19:59:16  swift
 * Modified acceptable O2 string from SBE43.
 *
 * Revision 1.6  2005/01/06 01:40:22  swift
 * Added PT capability.
 *
 * Revision 1.5  2004/09/11 17:06:48  swift
 * Changed Entry() to Add().
 *
 * Revision 1.4  2002/04/30 21:38:58  swift
 * Added provision for SeaBird SBE41 with DO sensor.  Added provision
 * for an ocean with a bottom.
 *
 * Revision 1.3  2001/10/15 17:40:42  swift
 * Minor fix-up.
 *
 * Revision 1.2  2001/10/15 17:37:10  swift
 * Modified email protocol to no more than one message per minute.
 *
 * Revision 1.1  2001/10/15 15:10:47  swift
 * Initial revision
 *
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define FmsChangeLog "$RCSfile: fmsRossSeaIce.cpp,v $  $Revision: 1.8 $  $Date: 2006/11/04 16:42:47 $"

#define LEADER  "Float Mission Simulator [SwiftWare]"
#define VERSION "$Revision: 1.8 $  $Date: 2006/11/04 16:42:47 $"
